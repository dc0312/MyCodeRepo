...
public class Employee2 {
	...
	public static void main(String[] args) {
		...
		Map<String, Long> noOfMaleAndFemale = employeeList.parallelStream().collect(Collectors.groupingBy(Employee1::getGender,Collectors.counting()));
		System.out.println(noOfMaleAndFemale);
		
		//print all department in the organization
	}
