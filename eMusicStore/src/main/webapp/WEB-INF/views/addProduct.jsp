...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Please fill the below details to add the product.</p>
        </div>
        ...
        <div class="form-group">
            ...
            <label class="checkbox-inline"><form:radiobutton path="productCategory" id="status"
                                                             value="inactive"/>Inactive</label>
        </div>

        <div class="form-group">
            <label for="unitInStock">Unit in Stocks</label><form:errors path="unitInStock" cssStyle="color: #ff0000"/>
